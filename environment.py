        ...
        if agent is self.primary_agent:
            if state['location'] == state['destination']:
                ...
                with open("BasicResults.txt", "a") as myfile:
                    myfile.write("Primary agency has reached destination! : "+
                        " with a total reward of "+ str(self.primary_agent.totalreward) +
                        " within this many moves: " + str(self.primary_agent.steps)+ "\n")           
